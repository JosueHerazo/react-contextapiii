...
//  se puede ir agrengando mas objetos o valores desde el initial state
 export const initialState : BudgetState ={
  ...
  // el valor quda como el valor de Expense, por lo tanto se le añade un id, seguido. se crea el id con el valor de la extension de uuidv4()
